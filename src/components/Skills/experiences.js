const experiences = [
  ...
  },
  {
    ...
    title: "Software Engineer Intern",
    info: [
      "Developed a web application leveraging React.js, PHP, and SQL to automate the generation of Response Managment Documents.",
      "Integrated data visualization and communication technologies such as Salesforce, Slack, and Microsoft Dynamics into the Loopio web application",
      "Engineered comprehensive functional, E2E, and unit tests using Jest, PHPUnit, and Selenium to ensure 95%+ code coverage, and incorporated them into Jenkins/ Bitbucket CI/CD pipelines.",
      "Explored neural network implementations of asymmetric semantic search algorithms using the vectorization of hrases to match questions with potential responses",
    ],
  },
  {
